...
# grab the list of image paths and initialize the index to store the image filename and feature vector
...
for (i, k) in enumerate(keys):
	...
	# load the current image and compute the Euclidean distance between the query image (i.e. the 1st image) and the current image
